...
ALTER TABLE `attendance`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `lesson_user_unique` (`lesson_id`,`student_id`) USING BTREE,
  ADD KEY `fk_attendance_users` (`student_id`);
...
ALTER TABLE `class_memberships`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `class_user_id` (`class_id`,`user_id`) USING BTREE;
...
ALTER TABLE `lessons`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `class_id_date_start_time` (`class_id`,`date`,`start_time`) USING BTREE;
...
ALTER TABLE `submissions`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `assinment_student_unique` (`assinment_id`,`student_id`) USING BTREE;
...
--
ALTER TABLE `attendance`
  ADD CONSTRAINT `fk_attendance_lessons` FOREIGN KEY (`lesson_id`) REFERENCES `lessons` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_attendance_users` FOREIGN KEY (`student_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
